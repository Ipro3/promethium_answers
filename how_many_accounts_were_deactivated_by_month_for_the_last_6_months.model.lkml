...
explore: fact_subscription_activity__c2ef7bbc_2b8e_41b5_b1d2_cf36294e4e79 {

join: DIM_PLAN__0b725578_2d90_4471_8c69_ac0b0e10e1e9 {
 type: left_outer
 relationship: many_to_one
 sql_on: ${fact_subscription_activity__c2ef7bbc_2b8e_41b5_b1d2_cf36294e4e79.plan_id} = ${DIM_PLAN__0b725578_2d90_4471_8c69_ac0b0e10e1e9.PLAN_ID} ;;
}
join: MASTER_PLAN_TABLE_WDATES__07691dec_838d_4902_be50_73d2b77503bd {
 type: right_outer
 relationship: many_to_one
 sql_on: ${fact_subscription_activity__c2ef7bbc_2b8e_41b5_b1d2_cf36294e4e79.plan_id} = ${MASTER_PLAN_TABLE_WDATES__07691dec_838d_4902_be50_73d2b77503bd.PLAN_ID} ;;
}
}


view: fact_subscription_activity__c2ef7bbc_2b8e_41b5_b1d2_cf36294e4e79 {
...
set: detail {
fields: [sbscrn_actvty_key, sbscrn_id, agn_key, used_actvty_type_id, actvty_dt, actvty_ts, hhld_id, prty_key, prty_id, parnt_acct_key, parnt_acct_id, parnt_acct_num, child_acct_key, child_acct_id, child_acct_num, veh_key, dvc_key, dvc_id, eqmnt_key, eqmnt_id, plan_key, plan_id, ofr_id, from_plan_key, from_plan_id, from_ofr_id, prod_key, prod_id, from_prod_key, from_prod_id, pkg_id, from_pkg_id, feat_id, csr_id, ptnr_id, lnkd_inet_fl, mrd_type_cd, sbscr_lifcyc_key, conv_rep_own_segmt_key, ownr_type2_key, deactivation_reason_code, trial_id, srvc_id, renw_id, from_renw_id, coll_scnro_id, srvc_lvl_pmt_key, nonpay_srvc_key, billing_method, from_billing_method, slfpay_turnover_rsn, slfpay_turnover_dt, future_deactvn_dt, schd_seasonal_susp_reactvn_dt, call_reason, call_disposition, inse_user_id, inse_ts, updt_user_id, updt_ts, save_activity, deact_activity_by_save_agent, conversion_activity_by_save_agent, save_opportunity_activity, actvty_type_id]
}
}


view: DIM_PLAN__0b725578_2d90_4471_8c69_ac0b0e10e1e9 {
...
view: MASTER_PLAN_TABLE_WDATES__07691dec_838d_4902_be50_73d2b77503bd {
