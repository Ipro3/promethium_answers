...
explore: FACT_SUBSCRIPTION_ACTIVITY__4fff27aa_5830_44fe_884f_68e789623032 {

join: DIM_DEVICE__f0fc0805_39d2_4a3b_a3bc_692113a6deb8 {
 type: left_outer
 relationship: many_to_one
 sql_on: ${DIM_DEVICE__f0fc0805_39d2_4a3b_a3bc_692113a6deb8.DEVICE_RECORD_KEY} = ${FACT_SUBSCRIPTION_ACTIVITY__4fff27aa_5830_44fe_884f_68e789623032.DVC_KEY} ;;
}
join: MASTER_PLAN_TABLE_WDATES__8ce448ca_887e_41b0_b043_20502dca8a36 {
 type: left_outer
 relationship: many_to_one
 sql_on: ${FACT_SUBSCRIPTION_ACTIVITY__4fff27aa_5830_44fe_884f_68e789623032.PLAN_ID} = ${MASTER_PLAN_TABLE_WDATES__8ce448ca_887e_41b0_b043_20502dca8a36.PLAN_ID} ;;
}
}


view: MASTER_PLAN_TABLE_WDATES__8ce448ca_887e_41b0_b043_20502dca8a36 {
...
view: FACT_SUBSCRIPTION_ACTIVITY__4fff27aa_5830_44fe_884f_68e789623032 {
...
set: detail {
fields: [SBSCRN_ACTVTY_KEY, SBSCRN_ID, ACTVTY_TYPE_ID, USED_ACTVTY_TYPE_ID, ACTVTY_DT, ACTVTY_TS, HHLD_ID, PRTY_KEY, PRTY_ID, PARNT_ACCT_KEY, PARNT_ACCT_ID, PARNT_ACCT_NUM, CHILD_ACCT_KEY, CHILD_ACCT_ID, CHILD_ACCT_NUM, VEH_KEY, DVC_ID, EQMNT_KEY, EQMNT_ID, PLAN_KEY, OFR_ID, FROM_PLAN_KEY, FROM_PLAN_ID, FROM_OFR_ID, PROD_KEY, PROD_ID, FROM_PROD_KEY, FROM_PROD_ID, PKG_ID, FROM_PKG_ID, FEAT_ID, AGN_KEY, CSR_ID, PTNR_ID, LNKD_INET_FL, MRD_TYPE_CD, SBSCR_LIFCYC_KEY, CONV_REP_OWN_SEGMT_KEY, OWNR_TYPE2_KEY, DEACTIVATION_REASON_CODE, TRIAL_ID, SRVC_ID, RENW_ID, FROM_RENW_ID, COLL_SCNRO_ID, SRVC_LVL_PMT_KEY, NONPAY_SRVC_KEY, BILLING_METHOD, FROM_BILLING_METHOD, SLFPAY_TURNOVER_RSN, SLFPAY_TURNOVER_DT, FUTURE_DEACTVN_DT, SCHD_SEASONAL_SUSP_REACTVN_DT, CALL_REASON, CALL_DISPOSITION, INSE_USER_ID, INSE_TS, UPDT_USER_ID, UPDT_TS]
}
}


view: DIM_DEVICE__f0fc0805_39d2_4a3b_a3bc_692113a6deb8 {
