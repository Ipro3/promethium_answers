...
explore: ACCOUNT__f3a0bbbb_d2ad_48ce_9e41_d9f189031568 {

join: ACCOUNTCLEANINFO__51823698_f268_4426_a129_802f4665978f {
 relationship: one_to_one
 sql_on: ${null."sforce"."SFORCE"."ACCOUNT"."ID"} = ${null."sforce_direct"."SFORCE"."ACCOUNTCLEANINFO"."ACCOUNTID"} 
 and ${null."sforce_direct"."SFORCE"."ACCOUNTCLEANINFO"."ID"} = ${null."sforce"."SFORCE"."ACCOUNT"."ID"} ;;
}
}


view: ACCOUNT__d1461c14_64da_4686_b395_61cd559e3e95 {
...
view: ACCOUNT__f3a0bbbb_d2ad_48ce_9e41_d9f189031568 {
...
view: ACCOUNTCLEANINFO__51823698_f268_4426_a129_802f4665978f {
sql_table_name:sforce_direct.SFORCE.ACCOUNTCLEANINFO ;;
dimension: ID {
 type: string
 sql: ${TABLE}.ID;;
}
